        ...
        var activePanelClass = 'selected-type-options',
            swatchProductAttributes = {
                ...
                bindAttributeInputType: function () {
                    ...
                    var filterableFrontendInputs = $.merge(this.selectFields, ['text', 'boolean', 'smile_custom_entity']);
                ...
                switchDefaultValueField: function () {
                    var currentValue = this.frontendInput.val(),
                        ...
                        defaultCustomEntityAttributeSetId = false,
                    ...
                    /* Smile - custom entity attributes */
                    this.setRowVisibility(this.customEntityAttributeSetIdField, defaultCustomEntityAttributeSetId);
